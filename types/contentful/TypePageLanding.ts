...
export interface TypePageLandingFields {
    ...
    sections: Entry<TypeBannerFields | TypeCallToActionFields | TypeCardsWithFormFields | TypeFooterFields | TypeFormFields | TypeGalleryFields | TypeHeaderFields | TypeHeroImageFields | TypeSetOfCardFields | TypeSetOfTestimonialsFields>[];
}
